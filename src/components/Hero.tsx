  ...
  return (
    <div id="about">
      <div className="flex items-center justify-center relative py-8 lg:py-20 px-4 lg:px-8 z-10 clip-path-custom-polygon h-screen 2xl:h-fit">
        ...
        <div className="absolute flex justify-center md:justify-end w-full h-screen max-w-[1360px] overflow-hidden px-0 md:px-[30px] top-1/2 left-1/2 translate-x-[-50%] translate-y-[-50%] ">
          <HeroBgAnimation />
        </div>
        ...
        <div className="relative flex flex-col justify-between items-center w-full max-w-[1100px] lg:flex-row">
          ...
          >
            ...
            <p className="text-base lg:text-xl mb-10">{Bio.description}</p>
            <Link
              href={Bio.resume}
              target="_blank"
